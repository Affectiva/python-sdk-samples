...
header_row = ['TimeStamp', 'faceId', 'upperLeftX', 'upperLeftY', 'lowerRightX', 'lowerRightY', 'confidence', 'interocular_distance',
        ...
        'blink', 'blink_rate', 'eye_widen', 'inner_brow_raise', 'lip_corner_depressor', 'gaze_region', 'gaze_confidence', 'glasses'
        ]
...
def write_metrics_to_csv_data_list(args, csv_data, timestamp, listener_metrics):
    """
