...
activated_expressions = {af.affvisionpy.Expression.eye_closure, af.affvisionpy.Expression.yawn, af.affvisionpy.Expression.blink}
activated_emotions = {af.affvisionpy.Emotion.joy, af.affvisionpy.Emotion.anger, af.affvisionpy.Emotion.surprise, af.affvisionpy.Emotion.fear, 
af.affvisionpy.Emotion.disgust, af.affvisionpy.Emotion.sadness}
...
def run(csv_data):
    ...
    detector.enable_features({af.Feature.identity, af.Feature.appearances, af.Feature.emotions, af.Feature.expressions})
